...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='EEG-to-Text HMM Pipeline (Streaming)')
...
def main():
    ...
    print("=" * 70)
    print("EEG-TO-TEXT HMM PIPELINE (STREAMING VERSION)")
    print("=" * 70)
    print()
    ...
    # STEP 4: Train CNN in streaming fashion
    print("STEP 4: Training CNN Encoder (Streaming)")
    print("-" * 70)
    ...
    # Setup optimizer
    optimizer = torch.optim.Adam(encoder.parameters(), lr=args.cnn_lr)
    ...
    for epoch in range(args.cnn_epochs):
        ...
        for chunk_idx in range(0, len(train_files_list), args.chunk_size):
            ...
            # Free memory
            del X_chunk, dataset, train_loader, chunk_data
